...
# --- MODIFICATIONS POUR VOTRE OPTIMISATION INTEL ULTRA 9 ---
# J'ai retiré les ":-" pour FORCER ces valeurs, le script ne devrait plus vous embêter.
var_cpu="16"             # Utilisation de vos coeurs
var_ram="65536"          # 64 Go de RAM
var_disk="100"           # J'ai mis 100Go (25Go est trop juste pour stocker des modèles LLM)
var_os="ubuntu"          # Force Ubuntu
var_version="24.04"      # Force Noble (Indispensable pour vos drivers Intel)
var_unprivileged="1"
var_gpu="yes"            # Active le mapping de base
# -----------------------------------------------------------
